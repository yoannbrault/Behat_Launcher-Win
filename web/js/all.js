...
blApp.config(function($translateProvider, $routeProvider, $locationProvider) {
    ...
    $routeProvider.when("/", {
        ...
        templateUrl: "run_list.html"
    }).when("/runs/:id", {
        controller: "RunShowCtrl",
        templateUrl: "run_show.html"
    }).when("/create", {
        controller: "RunCreateCtrl",
        templateUrl: "run_create.html",
        reloadOnSearch: false
    }).when("/output/:id", {
        controller: "OutputFileShowCtrl",
        templateUrl: "outputFile_show.html"
    });
});
...
blApp.factory("ProjectList", function($rootScope, $interval, ProjectListResource, ProjectResource) {
    ...
    ProjectList.prototype.setAutorefresh = function(autorefresh) {
        ...
        if (this.autorefresh && !this.interval) {
            this.interval = $interval(this.updateList, 2e3);
    ...
    ProjectList.prototype.updateList = function() {
        ...
        ProjectListResource.query().$promise.then(function(projects) {
            ...
            $rootScope.$broadcast("projectlist_update", {
                projects: projects
            });
        });
    };
    ProjectList.prototype.updateOne = function(name) {
        ...
        ProjectResource.get({
            ...
            $rootScope.$broadcast("project_update", {
                project: project
            });
        });
    };
...
blApp.factory("Run", function($resource, $rootScope, $interval) {
    ...
    Run.prototype.save = function(callback) {
        ...
        $res.$save(function(msg, headers) {
            self.hydrate(msg);
            $rootScope.$broadcast("run_update", {
                run: self
            });
            callback(self);
        });
...
blApp.factory("RunList", function($resource, $interval, $rootScope) {
    ...
    RunList.prototype.hydrate = function(data) {
        this.runs = data;
        $rootScope.$broadcast("runlist_update", {
            runs: this.runs
        });
    };
